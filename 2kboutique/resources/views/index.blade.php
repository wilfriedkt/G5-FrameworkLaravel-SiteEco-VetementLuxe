...
<body class="bodyAll">
    <div class ="header">
        <div class="container">
            <div class="navbar">
                <div class="logo">
                    <a href="{{ url('/') }}"><img src="images/logo_2kboutique.png" width="100px"
                            height="60px"></a>
                </div>
                <nav>
                    <ul id="MenuItems">
                        ...
                        @auth
                        <li><a href="{{ url('/wishlist') }}">Favoris</a></li>
                        @endauth
                            ...
                            <li>
                                <a href="{{ url('/profile') }}">
                                    <img width="45" height="45"
                                        src="https://img.icons8.com/external-creatype-outline-colourcreatype/64/external-account-essential-ui-v4-creatype-outline-colourcreatype.png"
                                        alt="Profil">
                                </a>
                            </li>
                        @else
                ...
                <a href="{{ url('/cart') }}"><img src="{{ asset('images/cart.png') }}" width="30px" height="30px"
                        alt="Panier"></a>
            ...
            <div class="row" style="margin-left: 50px;">
                <div class="col-2">
                    ...
                    <p>Plongez dans un univers où raffinement et tendance se rencontrent. Notre boutique vous propose
                        une selection exclusive de vetements de luxe
                ...
                <div class="col-2">
                    <img class="img-acceuille" src="{{ asset('images/gallery-2.jpg') }}" style="margin-left: 80px;"
                        alt="Accueil">
                </div>
            </div>
        </div>
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <small> Achetez les dernières collections de vetements Gucci en ligne sur 2kboutique aux meilleurs
                        prix, parmi les plus grandes marques telles qu'Adidas, Nike, Puma, Asics et Sparx, et profitez
                        de votre shopping en toute tranquillité.</small><br>
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <p>J’ai fait des achats sur de nombreuses boutiques en ligne, mais celle-ci se démarque vraiment !
                        Le produit a dépassé mes attentes en termes de qualité et d’apparence. De plus, la livraison
                        gratuite était un excellent bonus ! Je reviendrai certainement pour d’autres achats.</p>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col-3">
                    <i class="fa fa-quote-left"></i>
                    <p>Wow ! Je suis vraiment impressionné par le service et la qualité du produit que j’ai acheté. Le
                        site était facile à naviguer, et la livraison a été ultra rapide. En plus, la remise que j’ai
                        eue a rendu l’achat encore plus intéressant ! Je recommande vivement.</p>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
